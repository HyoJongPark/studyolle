...
class AccountControllerTest {
    ...
    @DisplayName("회원 가입 처리 - 정상 입력")
    @Test
    void signUpSubmit_with_collect_input() throws Exception {
        mockMvc.perform(post("/sign-up")
                        .param("nickname", "park")
    ...
    @DisplayName("인증 메일 확인 - 정상 입력")
    @Test
    void checkEmailToken_with_collect_input() throws Exception {
